...
\DeclareTOCStyleEntry[dynnumwidth]{default}{equation}
%%%%%%%%%% DOCUMENT %%%%%%%%%%
\begin{document}
...
\tableofcontents
\listoftables
\addcontentsline{toc}{chapter}{List of Tables}  % For books and reports
\listoffigures
